...
from resnet12 import DropBlock
...
class ResNet(nn.Layer):
    ...
    def __init__(self,
        ...
        self.layer3 = self._make_layer(block, 256, layers[2], stride=2, drop_block=True)
        self.layer4 = self._make_layer(block, 300, layers[3], stride=2, drop_block=True)

    def _make_layer(self, block, planes, blocks, stride=1, dilate=False,drop_block=False):
        ...
        layers.append(
            block(self.inplanes, planes, stride, downsample, self.groups,
                  self.base_width, previous_dilation, norm_layer, drop_block=drop_block))
...
if __name__ == '__main__':
    model = resnet34()
    paddle.summary(model, input=paddle.randn([1, 3, 224, 224]))
