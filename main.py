...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.max_epoch):
        ...
        for images_train, labels_train, images_test, labels_test, pids in trainloader:
            ...
            ytest, cls_scores = model.train_forward(images_train, images_test, labels_train_1hot, labels_test_1hot)
...
def val(model, testloader):
    ...
    with paddle.no_grad():
        for images_train, labels_train, images_test, labels_test, _ in testloader:
            ...
            cls_scores = model.train_forward(images_train, images_test, labels_train_1hot, labels_test_1hot)
